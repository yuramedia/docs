...
:::caution[Dua kesalahan terbesar di genre ini]

1. **Ketegangan hilang karena kalimat terlalu panjang** — terjemahan yang terlalu lengkap dan gramatikal justru memecah ritme suspense yang dibangun oleh penulis asli.
2. **Plot twist bocor karena pilihan kata yang terlalu jelas** — satu kata yang terlalu spesifik terlalu awal bisa secara tidak sengaja mengungkap identitas pelaku atau arah cerita.

Kedua hal ini merusak pengalaman menonton sebelum cerita sendiri sampai ke sana.
:::

---

## 1. Prinsip Khusus Genre Thriller
...
| **Ambiguitas yang disengaja harus dijaga**       | Petunjuk (_clue_) harus tetap samar. _Red herring_ harus tetap meyakinkan. Jangan pilih kata yang terlalu spesifik sebelum cerita siap mengungkapkannya.                                |
...
Lihat aturan umum nama di [Panduan Utama — Bagian 2.1](/guides/panduan-terjemahan-serial-pendek-cina-ke-indonesia/#21-nama--sebutan). Aturan di bawah ini adalah **tambahan khusus** untuk karakter dalam setting investigasi dan kriminal.

### Penegak Hukum & Investigator
...
:::tip[Nama antagonis dan momen reveal]
Jika nama antagonis disebut sejak awal tapi identitas aslinya baru terungkap di akhir, pastikan tidak ada terjemahan narasi atau dialog yang mengisyaratkan "kejahatannya" terlalu awal. Nama harus bisa dibaca sebagai tokoh netral sampai cerita memutuskan sebaliknya.
:::

---

## 3. Terminologi Investigasi & Hukum
...
:::caution[Jangan haluskan ancaman tersirat]
Dialog antagonis yang mengancam secara tersirat harus diterjemahkan dengan panjang yang sama atau lebih pendek dari aslinya. Kalimat panjang menghilangkan efek dingin. "Hati-hati." jauh lebih mengancam dari "Tolong lebih berhati-hati dalam langkahmu ke depan."
:::

### Saksi / Karakter Ketakutan
...
### Kalimat Pendek untuk Puncak Ketegangan
...
### _Red Herring_ — Petunjuk Palsu

_Red herring_ harus terdengar meyakinkan sebagai petunjuk nyata. Jangan pilih kata yang terasa "terlalu dicari-cari" atau justru terlalu jelas sebagai jebakan.
...
## 6. Tropes Genre & Cara Menerjemahkannya
...
:::note[Psikologis bukan label]
Jangan gunakan istilah klinis sebagai label merendahkan. "Dia psikopat" sebagai serangan dalam dialog boleh dipertahankan jika memang itu nada adegan; tapi narasi atau penjelasan medis harus menggunakan terminologi yang akurat.
:::

---

## 8. Konten Sensitif & Kepatuhan
...
| Referensi ke kekerasan yang tidak relevan dengan plot | Pertimbangkan untuk disamarkan — lihat [Panduan Utama — Bagian 5](/guides/panduan-terjemahan-serial-pendek-cina-ke-indonesia/#5-kepatuhan-hukum--regulasi) |

### Referensi ke Lembaga Nyata
...
### Konten SARA dalam Konteks Kriminal
...
### Istilah hukum terasa asing atau kaku
...
### Plot twist tidak terasa mengejutkan
...
### Bahasa karakter semua terasa sama

Di akhir episode, semua tokoh — detektif, tersangka, saksi — terdengar dengan register yang identik.

**Solusi:** Sebelum mulai menerjemahkan, tulis satu kalimat yang menggambarkan "cara bicara" setiap tokoh utama. Contoh: _"Detektif Rendra bicara singkat dan observasional, tidak pernah menggunakan kalimat lebih dari 10 kata di adegan tegang."_ Pegang itu sepanjang episode.

---

## Lihat Juga

- [Panduan Terjemahan Serial Pendek — Cina ke Indonesia](/guides/panduan-terjemahan-serial-pendek-cina-ke-indonesia/) — aturan umum yang tetap berlaku, termasuk kepatuhan konten Bagian 5
- [Panduan Lokalisasi Istilah — Tab Thriller](/reference/istilah/) — tabel referensi cepat istilah investigasi, psikologi, dan aksi
- [Panduan QC](/guides/panduan-qc/) — checklist review, khususnya poin naturalness terjemahan (L1), konten sensitif (S1–S5), dan konsistensi karakter (K3)
- [Panduan Aegisub](/guides/panduan-aegisub/) — cara memeriksa panjang kalimat dan timing untuk adegan aksi
