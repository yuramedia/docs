...
1. **Register tidak mengikuti fase hubungan** — tokoh yang sudah akrab masih bicara seperti orang asing, atau tokoh yang baru kenal tiba-tiba sudah sangat intim.
2. **Tropes diterjemahkan harfiah** — frasa khas genre romansa yang diterjemahkan kata per kata terdengar canggung dan tidak alami di bahasa Indonesia.

Kedua hal ini langsung merusak chemistry dan ritme emosi cerita.
:::

---

## 1. Prinsip Khusus Genre Romansa & Drama

| Prinsip                               | Penjelasan                                                                                                                                              |
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Register mengikuti fase hubungan**  | Cara bicara tokoh harus berubah seiring perkembangan hubungan — dari formal ke akrab, atau sebaliknya saat konflik. Perubahan register _adalah_ narasi. |
| **Emosi adalah nyawa cerita**         | Dialog romansa sering pendek tapi bermuatan besar. Pilih kata yang terasa _berasa_, bukan sekadar tepat secara makna.                                   |
...
Lihat aturan umum nama di [Panduan Utama — Bagian 2.1](/guides/panduan-terjemahan-serial-pendek-cina-ke-indonesia/#21-nama--sebutan). Aturan di bawah ini adalah **tambahan khusus** untuk setting modern genre romansa.
...
:::tip[Nama panggilan konsisten per pasangan]
Setiap pasangan tokoh punya sapaan khasnya masing-masing. Catat di glosarium proyek sejak kemunculan pertama dan jaga konsistensi hingga akhir. Perubahan sapaan (misalnya dari "Kak" ke "Mas" atau dari nama lengkap ke nama pendek) biasanya merupakan penanda momen penting yang harus tetap terbaca.
:::

---

## 3. Dinamika Hubungan & Sapaan

### Antar Pasangan Kekasih / Suami-Istri
...
:::caution[Perubahan kata ganti = perubahan hubungan]
Ketika seorang tokoh tiba-tiba berganti dari "aku/kamu" ke "saya/kamu", itu bukan kekeliruan — itu narasi. Jaga perubahan ini, karena penonon membacanya sebagai sinyal emosional.
:::
...
### Hubungan Bos dan Bawahan (Romansa Kantor)
...
## 4. Register Bahasa per Fase Cerita
...
| **Konflik besar**                    | Kembali formal atau justru eksplosif | Pilih salah satu: sangat dingin _atau_ sangat emosional — jangan di tengah |
| **Rekonsiliasi / ending**            | Hangat, tenang                       | Pilihan kata sederhana tapi berbobot, sering tanpa kalimat panjang         |

---

## 5. Tropes Genre & Cara Menerjemahkannya

Genre romansa memiliki pola cerita (tropes) yang sudah dikenal penonton. Menerjemahkan tropes dengan tepat artinya mempertahankan _efek emosional_ yang diharapkan penonton, bukan sekadar kata-katanya.

### CEO Galak / Bos Arogan (霸道总裁)
...
## 6. Dialog Emosi & Adegan Kunci

### Adegan Konflik & Pertengkaran
...
## 7. Hubungan Keluarga & Dinamika Sosial
...
## 8. Idiom & Ekspresi Khas Genre Romansa
...
### Bahasa Gaul yang Boleh Digunakan
...
:::caution[Batasan penggunaan gaul]
Bahasa gaul **tidak boleh digunakan** dalam: dialog mertua kepada menantu (konteks formal), adegan ungkap perasaan yang serius, atau adegan konflik emosional besar. Di momen-momen berat, bahasa yang lebih bersih justru terasa lebih bertenaga.
:::
...
### Perubahan register tidak terbaca
...
- [Panduan Terjemahan Serial Pendek — Cina ke Indonesia](/guides/panduan-terjemahan-serial-pendek-cina-ke-indonesia/) — aturan umum yang tetap berlaku
- [Panduan Lokalisasi Istilah — Tab Romansa & Drama](/reference/istilah/) — tabel referensi cepat istilah genre ini
- [Panduan QC](/guides/panduan-qc/) — checklist review, khususnya poin konsistensi register (K3) dan naturalness terjemahan (L1, L7)
