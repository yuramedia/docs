...
<Callout type="warn" title="QC bukan tugas penerjemah">
...
<Callout type="idea" title="Cara cepat cek overlap di Aegisub">
...
<Callout type="warn" title="Satu error S otomatis Revisi Mayor">
