...
:::caution
**Dilarang menggunakan mesin penerjemah. Dilarang ada karakter Mandarin, kode rusak, atau konten yang tidak relevan dengan cerita.**
:::

---

## 2. Solusi Lokalisasi Terminologi
...
- Nama lengkap tidak perlu menggunakan _middle name_.
...
- Hindari nama yang sensitif atau ambigu:
    - ❌ _Muhammad_ — terkait tokoh besar Islam, tidak boleh digunakan.
    - ❌ _Hari_ (artinya "hari/siang"), _Pedang_ (artinya "pedang") — tidak boleh dijadikan nama karena menimbulkan ambiguitas.
- Karya berlatar **zaman kuno** harus menggunakan nama Indonesia kuno; nama modern (apalagi serapan Barat seperti _Lily_, _Luis_) tidak diperbolehkan.
...
- Nama dengan karakter **'儿' (-er)**: tulis sebagai pengulangan suku kata (contoh: _Han Han_). Jika terdengar aneh, boleh diubah asalkan konsisten.
...
| 毛zd         | _(hapus)_          | Mao               | Tokoh sensitif                                           |
| 死基佬       | _(hapus)_          | homo              | Sebutan diskriminatif                                    |
| black people | _(hapus)_          | orang hitam       | Sebutan diskriminatif                                    |
| Hitler       | _(hapus)_          | Hitler            | Tokoh sensitif                                           |

---

#### Perbandingan Menggunakan Nama Tokoh
...
:::tip
Jangan selalu menjadikan Jakarta sebagai latar. Kota besar Indonesia lainnya seperti **Surabaya, Medan, Denpasar, Palembang**, dll. bisa digunakan.
:::
...
:::note
Jika teks asli menggambarkan suasana perayaan Tiongkok yang berbeda dari versi Indonesia (contoh: Tahun Baru Imlek), pertimbangkan untuk menulis ulang konteksnya agar sesuai kebiasaan Indonesia.
:::
...
### 2.8 Pengobatan Tradisional Tiongkok (TCM)
...
- **Nama titik akupuntur**: tulis sebagai **"Titik" + nama pinyin** dengan huruf kapital di awal, tanpa spasi. Saat beberapa titik disebutkan bersama, cukup tulis "Titik" di awal saja.
    > Contoh: _Titik Chize, Lieque, dan Taixi._
...
### 2.9 Istilah Budaya Tiongkok Lainnya
...
### 2.11 Tingkatan Kultivasi / Xianxia
...
- Gunakan tanda baca bahasa Indonesia yang benar; **dilarang menggunakan tanda baca bahasa Mandarin**.
- Satu spasi antara kata dan tanda baca.
- Ikuti panduan ejaan dari:
    - **EYD**: https://ejaan.kemendikdasmen.go.id/
    - **PUEBI**: https://puebi.js.org/
...
Semua satuan harus dikonversikan ke satuan umum Indonesia. Untuk satuan kuno (seperti _jin_ atau _chi_), lakukan konversi ke satuan modern terlebih dahulu, baru konversikan ke satuan Indonesia.
...
| **kami**             | **kita**         | _kami_ = tidak termasuk lawan bicara; _kita_ = termasuk lawan bicara |
...
:::caution
Game seperti _王者荣耀_ (Honor of Kings), _英雄联盟_ (League of Legends), _Fortnite_, dll. dapat menimbulkan masalah hak cipta.

- Muncul sedikit → samarkan
- Muncul banyak → pertimbangkan penggantian karya
  :::
...
## 6. Pertanyaan Umum & Solusi

### Q: Terjemahan terasa kaku dan tidak alami
...
:::note
Panduan ini bersifat acuan dan tidak dapat mencakup semua kasus. Saat menemukan istilah baru yang perlu adaptasi, segera tandai, tambahkan ke glosarium tim, dan diskusikan solusinya bersama.
:::
