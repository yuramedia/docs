...
QC (_Quality Control_) adalah tahap review akhir sebelum subtitle dikirim atau diterbitkan. Tujuannya adalah menangkap error yang lolos dari proses penerjemahan — baik teknis maupun konten — sehingga penonton tidak menemukan masalah di hasil akhir.
...
**Timing → Check Subtitle Consistency** → centang _Overlap with next subtitle_. Aegisub akan menandai semua baris yang bermasalah sekaligus.
:::
...
| F6  | Teks layar / keterangan                            | **Mighty/Dracin:** kurung `(…)` (`(Setelah 3 tahun)`) / **Netflix, CR, dll:** _Forced Narrative_ (ALL CAPS, `SETELAH 3 TAHUN`) |
...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| ✅ **Lulus**        | Tidak ada error _Wajib_                                                                                                               | File siap dikirim ke platform                             |
| 🔄 **Revisi Minor** | 1–5 catatan _Wajib_, tidak ada di kategori T, S                                                                                       | Perbaiki, kirim ulang ke QC untuk verifikasi cepat        |
| ⚠️ **Revisi Mayor** | Error di kategori teknis (T) atau konten sensitif (S), atau > 5 catatan _Wajib_                                                       | Kembalikan ke penerjemah, QC penuh diulang setelah revisi |
