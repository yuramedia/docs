...
1. **Pinyin mentah dibiarkan** — istilah seperti "qi", "shifu", "shixiong", "jianghu", atau nama jurus dalam pinyin tidak diterjemahkan, sehingga penonton awam tidak mengerti apa yang sedang terjadi.
2. **Tingkatan kultivasi tidak konsisten** — satu episode menyebut "Tingkat Puncak", episode berikutnya menyebut "Jindan", menciptakan kebingungan yang merusak logika cerita.

Kedua hal ini langsung merusak kredibilitas terjemahan dan pengalaman menonton.
:::
...
:::tip[Kapan pakai "Guru", kapan pakai "Suhu"]
**"Guru"** → hubungan formal dan berjarak; digunakan dalam adegan resmi atau saat murid belum akrab dengan pengajarnya.
**"Suhu"** → hubungan yang sudah terbentuk dan personal; lebih hangat. Pilih satu dan gunakan konsisten per pasangan tokoh.
:::
...
:::caution[Perhatikan urutan tingkatan]
Urutan **Langit → Bumi → Xuan → Dasar** (dari tinggi ke rendah) sering disalahpahami. "Langit" adalah yang **tertinggi**, bukan terendah. Pastikan konteks dialog sudah benar sebelum memutuskan terjemahan.
:::
...
### Kata Ganti Diri Berdasarkan Posisi
...
:::caution[Jangan ratakan semua ke "Aku" atau "Kamu"]
Perbedaan cara bicara junior ke senior vs senior ke junior adalah bagian dari karakter setiap tokoh. Hilangkan perbedaan ini dan semua orang terdengar sama.
:::
...
### Sapaan seperguruan terdengar kaku
...
- [Panduan Terjemahan Serial Pendek — Cina ke Indonesia](/guides/panduan-terjemahan-serial-pendek-cina-ke-indonesia/) — aturan umum yang tetap berlaku, termasuk bagian [Tingkatan Kultivasi](/guides/panduan-terjemahan-serial-pendek-cina-ke-indonesia/#211-tingkatan-kultivasi--xianxia)
- [Panduan Lokalisasi Istilah — Tab Xianxia / Wuxia](/reference/istilah/) — tabel referensi cepat istilah perguruan dan kultivasi
- [Panduan QC](/guides/panduan-qc/) — checklist review untuk konsistensi tingkatan (K2) dan nama jurus (T1)
