...
1. **Register bahasa tidak konsisten** — satu adegan formal, adegan berikutnya seperti drama modern.
2. **Hierarki tidak dijaga** — tokoh bawahan berbicara seperti setara dengan atasannya.

Kedua hal ini langsung merusak atmosfer drama kerajaan.
:::
...
:::tip[Nama era kuno yang direkomendasikan]
**Pria:** Arjuna, Baskara, Panji, Surya, Wijaya, Kertajaya, Bima, Satria, Arya, Buana
**Wanita:** Anjani, Arimbi, Dewi, Kusuma, Laksmi, Ratna, Srikandi, Wulandari, Candra, Sekar
:::
...
Daftar istilah lengkap ada di [Panduan Lokalisasi Istilah — Tab Historical / 古装剧](/reference/istilah/). Bagian ini membahas **cara penggunaannya dalam konteks dialog**.
...
:::caution[Jangan ratakan semua menjadi "Aku" atau "Saya"]
Menerjemahkan semua kata ganti diri menjadi "Aku" atau "Saya" menghilangkan hierarki yang menjadi inti drama kerajaan. "Hamba" dan "Kami" adalah pilihan yang membuat adegan terasa berbeda secara status.
:::
...
:::tip[Kapan pakai "Kami", kapan pakai "Aku"]
**"Kami"** → adegan formal: sidang, proklamasi, memberi hukuman, memberi titah kepada pejabat.
**"Aku"** → adegan intim: berbicara kepada orang dicintai, percakapan santai di kediaman pribadi.
:::
...
### Gelar berubah di tengah cerita
...
**Solusi:** Terjemahkan berdasarkan **fungsi atau dampaknya dalam cerita**, bukan nama istilahnya. Lihat kolom "Terjemahan" di tabel-tabel panduan ini dan di [Glosarium Historical](/reference/istilah/).
...
- [Panduan Lokalisasi Istilah — Tab Historical / 古装剧](/reference/istilah/) — tabel referensi cepat gelar dan istilah
- [Panduan QC](/guides/panduan-qc/) — checklist review khusus poin konsistensi gelar (K2) dan register bahasa (K3)
