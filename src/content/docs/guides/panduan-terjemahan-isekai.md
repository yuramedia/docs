...
1. **Istilah RPG dibiarkan dalam bahasa Inggris** — "Level Up", "Skill", "Status Window", "Quest" dipertahankan mentah-mentah padahal semua bisa dan harus diterjemahkan agar terasa hidup.
2. **Gelar feodal fantasi disamakan semua** — Duke, Count, Viscount, Baron diterjemahkan seragam sebagai "bangsawan" atau dibiarkan dalam bahasa Inggris, menghilangkan hierarki yang penting untuk logika politik dunia cerita.
...
## 1. Prinsip Khusus Genre Isekai / Fantasi
...
Lihat aturan umum nama di [Panduan Utama — Bagian 2.1](/guides/panduan-terjemahan-serial-pendek-cina-ke-indonesia/#21-nama--sebutan). Aturan di bawah ini adalah **tambahan khusus** untuk setting dunia fantasi.

### Tokoh Utama & Pendamping
...
### Nama Berdasarkan Elemen / Konsep
...
:::tip[Gunakan huruf kapital untuk notifikasi]
...
### Aturan Penamaan Mantra & Jurus Sihir
...
## 5. Gelar Bangsawan & Hierarki Feodal
...
:::caution[Jangan samakan semua jadi "bangsawan"]
...
## 7. Dialog & Gaya Bahasa

### Register per Jenis Tokoh
...
- [Panduan Lokalisasi Istilah — Tab Genre Isekai](/reference/istilah/) — tabel referensi cepat istilah sihir, gelar, dan RPG
- [Panduan QC](/guides/panduan-qc/) — checklist review untuk konsistensi sistem dan gelar bangsawan
